...
Drop photos and video here, then uncomment the matching line in the root `README.md`.
...
- **Video on GitHub:** drag an `.mp4` directly into a README edit box or an issue comment and
  GitHub hosts it inline with a player. Files must be under 10 MB. For longer clips, upload to
  YouTube and link a thumbnail image instead.
- **Photo size:** resize to roughly 1600 px wide before committing so the repo stays small.
- **A short GIF** of the rover moving is often more effective in a README than a full video.
